            ...
            <section className="mx-auto w-full max-w-7xl px-4 py-12 md:px-6 lg:px-8 lg:py-16">
                ...
                <div className="border-t border-slate-300">
                    {projects.map((project) => (
                        <article
                            key={project.number}
                            className="grid gap-5 border-b border-slate-300 py-7 lg:grid-cols-[5rem_minmax(20rem,1fr)_minmax(16rem,0.82fr)_20rem] lg:items-center lg:gap-8 lg:py-8"
                        >
                            ...
                            <div className="relative h-48 border border-slate-200 bg-slate-200 lg:h-44">
                                <Image
                                    src={project.image}
