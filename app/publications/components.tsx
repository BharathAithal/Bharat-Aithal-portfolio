    ...
    <ol className="content-panel divide-y divide-slate-200/80 p-4 sm:p-6">
      {chapters.map((ch, index) => (
        ...
        >
          ...
          <p className="text-sm font-medium leading-7 text-slate-500 sm:text-right">{ch.year}</p>
        </li>
      ))}
    </ol>
  );
    ...
    <ol className="content-panel divide-y divide-slate-200/80 p-4 sm:p-6">
      {reports.map((rep, index) => (
        ...
        >
          ...
          <p className="text-sm font-medium leading-7 text-slate-500 sm:text-right">{rep.year}</p>
        </li>
      ))}
    </ol>
  );
